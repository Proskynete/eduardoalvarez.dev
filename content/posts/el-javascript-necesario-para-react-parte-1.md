...
introduction:
  {
    title: 'Introducción',
    anchor: 'introduccion',
    content: 'Aprendamos el mínimo que debemos saber de **JavaScript** para empezar a crear nuestros primeros proyectos con **React** sin ningún problema. Pero primero... **¿Qué es React?**',
  }
sections:
  [
