...
import type { AlgoliaConfig } from "../../../../../../../src/layouts/base/components/header/components/types";
import { useAlgoliaSearch } from "../../../../../../../src/layouts/base/components/header/components/use-algolia-search";
  ...
  describe("Funcionalidad de búsqueda", () => {
    ...
    it("debe establecer isSearching a true durante la búsqueda", async () => {
      ...
      mockSearchForHits.mockImplementation(
        () => new Promise((resolve) => setTimeout(() => resolve({ results: [{ hits: mockSearchResults }] }), 100)),
      );
