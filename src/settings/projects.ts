export default {
  projects: [
    ...
    },
    {
      ...
      techStack: ["React", "TypeScript", "Styled Components", "Coveralls", "Jest"],
    },
    {
      title: "Pretty Rating React",
      githubLink: "https://github.com/Proskynete/pretty-rating-react",
      description: "A small and simple library that transform you rating in icons for you web",
      techStack: ["React", "TypeScript", "Styled Components", "Coveralls", "Jest"],
    },
    {
      title: "Node API Skeleton",
      githubLink: "https://github.com/Proskynete/node-api-skeleton",
      description: "Starter project for a Node API with TS, testing and CI/CD setup.",
