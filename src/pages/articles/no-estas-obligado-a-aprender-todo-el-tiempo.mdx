...
seo_description: "No tienes que aprender todo el tiempo. Cómo gestionar el burnout tecnológico y el síndrome del impostor eligiendo qué aprender con criterio."
...
faq:
  [
    {
      question: "¿Es normal sentir que no puedo seguir el ritmo de aprendizaje en tecnología?",
      answer: "Sí, es completamente normal. La industria tecnológica genera tanto contenido nuevo que ningún profesional puede mantenerse al día con todo. El problema no es tu capacidad sino la expectativa irreal de aprenderlo todo. Priorizar lo que tiene impacto directo en tu trabajo actual es la estrategia más sostenible.",
    },
    {
      question: "¿Cómo saber si estoy experimentando burnout tecnológico?",
      answer: "Las señales más comunes son: desgana al abrir el editor de código, sensación de culpa cuando no estás aprendiendo algo nuevo, dificultad para concentrarte en tareas que antes disfrutabas, y agotamiento que no desaparece después de dormir. Si identificas tres o más de estas señales de forma persistente, es momento de tomar un descanso deliberado.",
    },
    {
      question: "¿Cómo seleccionar qué tecnologías aprender sin sentirme abrumado?",
      answer: "Usa un criterio de relevancia inmediata: aprende lo que resuelve un problema que tienes ahora. Mantén una lista corta de tres tecnologías como máximo. Cuando aprendas una, puedes añadir otra. Esto crea un flujo sostenible en lugar de una lista infinita que genera ansiedad.",
    },
    {
      question: "¿Las pausas en el aprendizaje perjudican mi carrera en tecnología?",
      answer: "No. Las pausas deliberadas permiten consolidar lo aprendido, descansar el sistema cognitivo y volver con más energía. Los profesionales que respetan sus límites tienen carreras más largas y sostenibles. El síndrome del impostor nos hace creer que parar es fracasar, pero la evidencia apunta en la dirección contraria.",
    },
  ]
---
